...
const VendorItem = ({ vendor }) => (
  <div className="max-w-sm bg-brown border h-full border-gray-200 rounded-lg shadow ">
    <Link href="/singleItem/[slug]" as={`/singleItem/${vendor.slug}`}>
    ...
    <div className="p-5">
      ...
      <Link href="/singleItem/[slug]" as={`/singleItem/${vendor.slug}`} className='inline-flex items-center px-3 align-bottom py-2 text-sm font-medium text-center text-white bg-lbule rounded-lg hover:bg-lrose hover:text-brown focus:ring-4 focus:outline-none'>
        View Vendor
